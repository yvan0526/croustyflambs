    ...
    def main(self):
        ...
        for event in pygame.event.get():
            if event.type == game_end:
                if self.score < 0: # Casser la fenêtre met le score à une valeur négative et termine le jeu
                ...
                elif self.score < 410000000000000:
                ...
                elif self.score < 999999999999999:
